...
/* Routed pin properties */
#define BOARD_LED_BOARD_PERIPHERAL                                         GPIO1   /*!< Peripheral name */
#define BOARD_LED_BOARD_SIGNAL                                           gpio_io   /*!< Signal name */
#define BOARD_LED_BOARD_CHANNEL                                               9U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_LED_BOARD_GPIO                                               GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_LED_BOARD_GPIO_PIN                                              9U   /*!< GPIO pin number */
#define BOARD_LED_BOARD_GPIO_PIN_MASK                                 (1U << 9U)   /*!< GPIO pin mask */
#define BOARD_LED_BOARD_PORT                                               GPIO1   /*!< PORT peripheral base pointer */
